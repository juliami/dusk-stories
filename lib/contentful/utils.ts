...
export const normalizeCollection = (collection: UnresolvedLink<"Entry"> | Entry<TypeCollectionSkeleton, ChainModifiers, string> | Entry<TypeCollectionSkeleton> | undefined): Collection | undefined=> {
...
return ({
  ...
  year: typeof collection.fields.year === 'number' ? collection.fields.year : undefined,
})}
...
return ({
  ...
  rating: typeof story.fields.rating === 'number' ? story.fields.rating : undefined,
   synopsis: story.fields.synopsis
      ? documentToPlainTextString(story.fields.synopsis as Document)
      : undefined,  
  year: typeof story.fields.publicationYear === 'number' ? story.fields.publicationYear : undefined,
  collections: Array.isArray(story.fields.collection)
  ? story.fields.collection.map(collection => normalizeCollection(collection)).filter(isDefined)
  : []
